...
class _LeaderboardScreenState extends ConsumerState<LeaderboardScreen>
            ...
            data: (departmentOptions) {
              ...
              return Row(
                ...
                children: [
                  ...
                  Expanded(
                    flex: 2,
                    child: _buildDropdown("Year", _selectedYear, _yearOptions, (
                      newValue,
                    ) {
                      setState(() {
  ...
  Widget _buildPodium(List<LeaderboardEntry> top3) {
    ...
    // ✨ Wrap podium with AnimatedBuilder and the circular reveal
    return AnimatedBuilder(
      ...
      child: Container(
        ...
        child: Row(
          ...
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            // ✨ Pass the specific animation to each member
  ...
  // ✨ This widget now takes an animation and uses it
